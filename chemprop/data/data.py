...
class MoleculeDatapoint:
    ...
    def __init__(self,
        ...
        :param line: A list of strings generated by separating a line in a dataset CSV file by comma.
        :param args: Arguments.
        :param features: A numpy array containing additional features (ex. Morgan fingerprint).
        :param use_compound_names: Whether the dataset CSV includes the compound name on each line.
        """
        ...
        if use_compound_names:  # use_compound_names = None
...
class MoleculeDataset(Dataset):
    ...
    def mols(self) -> List[Chem.Mol]:
        ...
        """
        return [Chem.MolFromSmiles(d.smiles) for d in self.data]
    ...
    def get_random_batch(self, batch_size: int, seed: int = 123) -> List[MoleculeDatapoint]:
        """
        Randomly get a batch of specified size from the MoleculeDataset class.

        :param dataset: A MoleculeDataset object, containing multiple MoleculeDatapoint data.
        :param batch_size: Batch size, specifying the number of MoleculeDatapoints to be randomly selected.
        :return: A list containing batch_size number of MoleculeDatapoints.
        """

        # Ensure batch_size is not greater than the size of the dataset
        batch_size = min(batch_size, len(self))

        random.seed(seed)

        # Randomly select batch_size number of MoleculeDatapoints
    ...
    def remove_inds(self, idxs: List[int]):
        ...
        '''
        removed_data = deepcopy(self.data)
