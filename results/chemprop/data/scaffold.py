...
def generate_scaffold(mol: Union[str, Chem.Mol], include_chirality: bool = False) -> str:
    """
    Compute the Bemis-Murcko scaffold_split for a SMILES string.
...
def scaffold_to_smiles(mols: Union[List[str], List[Chem.Mol]],
    ...
    """
    Computes scaffold_split for each smiles string and returns a mapping from scaffolds to sets of smiles.

    :param mols: A list of smiles strings or RDKit molecules.
    :param use_indices: Whether to map to the smiles' index in all_smiles rather than mapping
    to the smiles string itself. This is necessary if there are duplicate smiles.
    :return: A dictionary mapping each unique scaffold_split to all smiles (or smiles indices) which have that scaffold_split.
    """
...
def scaffold_split(data: MoleculeDataset,
                   ...
                   logger: logging.Logger = None) -> Tuple[MoleculeDataset,
                                                           ...
                                                           MoleculeDataset]:
    """
    Split a dataset by scaffold_split so that no molecules sharing a scaffold_split are in the same split.
    ...
    # Map from scaffold_split to index in the dataset
    ...
    else:  # Sort from largest to smallest scaffold_split sets
...
def log_scaffold_stats(data: MoleculeDataset,
    ...
    :param data: A MoleculeDataset.
    :param index_sets: A list of sets of indices representing splits of the dataset.
    ...
    the first num_scaffolds scaffolds, sorted in decreasing order of scaffold_split frequency.
    """
    ...
    if logger is not None:
        logger.debug('Label averages per scaffold_split, in decreasing order of scaffold_split frequency,'
